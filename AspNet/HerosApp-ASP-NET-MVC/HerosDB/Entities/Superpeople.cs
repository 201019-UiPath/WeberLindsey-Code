...
namespace HerosDB.Entities
{
    public partial class Superpeople
    {
        ...
        //[Key] //Can also set using data annotations
        //[DataType(DataType.EmailAddress)] can use this to specify the type of data
        public int Id { get; set; } //By default this will be the Primary Key
